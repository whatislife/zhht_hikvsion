package com.zhht.hikvision.zhht_hikvsion.util;
...
public class JavaHttpUtil {
	...
	public static final String DEFAULT_PRE_URL = "http://XXX.XXX.XXX.XXX/webapi/service/"; //此处替换成平台SDK所在服务器IP与端口
	public static final String DEFAULT_APPKEY = "XXX";//此处替换成申请的appkey
	public static final String DEFAULT_SECRET = "XXX";//此处替换成申请的secret
